          ...
          <div className="max-w-xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Input
                ...
                className="bg-white text-black rounded-full px-6 py-3 flex-grow"
              />
...
>>>>>>> 65872114baca493f62c29b683cb35eed8ecf1397
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <Link href="#" className="h-8 w-8 rounded-full bg-gray-200 flex items-center justify-center">
            ...
            <div>
              <h3 className="font-medium text-sm uppercase text-gray-500 mb-4">HELP</h3>
              <ul className="space-y-2">
                <li>
                  <Link href="#" className="text-gray-600 hover:text-black">
                    Customer Support
            ...
            <div>
              <h3 className="font-medium text-sm uppercase text-gray-500 mb-4">FAQ</h3>
              <ul className="space-y-2">
                <li>
                  <Link href="#" className="text-gray-600 hover:text-black">
                    Account
          ...
          <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">&copy; 2023 QuickBuy, Inc. All Rights Reserved</p>
